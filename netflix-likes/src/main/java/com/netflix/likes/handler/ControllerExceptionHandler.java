package com.netflix.likes.handler;
...
import com.netflix.likes.handler.exception.EmptyResultDataAccessException;
import com.netflix.likes.handler.exception.InternalErrorException;
import com.netflix.likes.handler.exception.MovieException;
import com.netflix.likes.handler.exception.NotFoundException;
...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(value = { EmptyResultDataAccessException.class, NotFoundException.class, 
			UserException.class, SerieException.class, MovieException.class })
